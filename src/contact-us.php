...
<body class="overflow-x-hidden bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
    ...
    <nav class="bg-white dark:bg-gray-800 shadow-md fixed top-0 left-0 w-full z-50" id="navbar">
            ...
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="hidden md:flex space-x-6 text-xl">
                    <a href="../index.html#About-Us"
                        class="text-gray-700 dark:text-gray-300 hover:text-teal-500 dark:hover:text-teal-400">About
                        Us</a>
                    <a href="../index.html#Our-Services"
                        class="text-gray-700 dark:text-gray-300 hover:text-teal-500 dark:hover:text-teal-400">Our
                        Services</a>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-4">
                    <a href="../src/contact-us.php">
                        <button class="bg-teal-500 hover:bg-teal-600 p-2 rounded-xl text-white text-xl">Consult
                            Now</button>
                    </a>
        ...
        <div id="mobile-menu" class="md:hidden hidden bg-white dark:bg-gray-800 py-2 px-4">
            <a href="../index.html#About-Us"
                class="block py-2 text-gray-700 dark:text-gray-300 hover:text-teal-500 dark:hover:text-teal-400">About
                Us</a>
            <a href="../index.html#Our-Services"
                class="block py-2 text-gray-700 dark:text-gray-300 hover:text-teal-500 dark:hover:text-teal-400">Our
                Services</a>
            <a href="../src/contact-us.php"
    ...
    <!-- Contact Card -->
    <div class="max-w-7xl mx-auto px-6 py-10 mt-20 z-10 delay-[300ms] duration-[600ms] taos:translate-x-[200px] taos:opacity-0"
        ...
        <div
            ...
            <p class="text-gray-600 dark:text-gray-300">We'd love to hear from you! Whether you have questions about our
                services, need assistance with your financial management, or want to schedule a consultation, feel free
                to reach out to us through any of the following methods:</p>
            ...
            <p class="text-gray-600 dark:text-gray-300"><strong>Email 📧:</strong> <a
                    href="mailto:info@pocket-accts.co.uk"
                    class="text-teal-500 hover:text-teal-600">info@pocket-accts.co.uk</a></p>
            ...
            <p class="text-gray-600 dark:text-gray-300"> 👇 Alternatively, you can fill out the contact form below, and
                a member of our team will get back to you promptly!</p>
        </div>
    </div>

    <!-- Contact Form -->
    <div class="container mx-auto max-w-7xl py-10 px-4 md:px-0 delay-[300ms] duration-[600ms] taos:scale-[0.6] taos:opacity-0"
        ...
        <div class="container mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
            ...
            <div class="explore-footer">
                ...
                <ul class="space-y-2">
                    <li><a href="../index.html"
                            class="text-gray-400 dark:text-gray-300 hover:text-teal-400 transition dark:hover:text-teal-400">Home</a></li>
                    <li><a href="../index.html#About-Us"
                            class="text-gray-400 dark:text-gray-300 hover:text-teal-400 transition dark:hover:text-teal-400">About Us</a></li>
                    <li><a href="../index.html#Our-Services"
                            class="text-gray-400 dark:text-gray-300 hover:text-teal-400 transition dark:hover:text-teal-400">Our Services</a>
                    </li>
                    <li><a href="../src/contact-us.php"
                            class="text-gray-400 dark:text-gray-300 hover:text-teal-400 transition dark:hover:text-teal-400">Contact
                            Us</a></li>
                </ul>
            </div>
            ...
            <div class="social-footer">
                ...
                <div class="flex justify-center md:justify-start space-x-4 mt-2">
                    <a href="#" class="text-gray-400 dark:text-gray-300 hover:text-teal-400 transition dark:hover:text-teal-400">
    ...
    <script>
        ...
        function updateThemeIcons(isDark) {
            desktopSunIcon.classList.toggle('hidden', isDark);
            desktopMoonIcon.classList.toggle('hidden', !isDark);
        ...
        // Handle database status layout independently
        document.addEventListener('DOMContentLoaded', function () {
            <?php if (!$dbStatus): ?>
                const formContainer = document.querySelector('.grid.grid-cols-1.md\\:grid-cols-2');
                if (formContainer) {
